...
import { ArrowLeft, Trophy, RotateCcw, MessageCircle, Settings, Heart, PieChart, Palette } from "lucide-react";
      ...
      <div className="pt-24 px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">Answer 10 questions to discover your ideal career path</p>
          </div>
                ...
                <div className="mb-8">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm text-muted-foreground">
                      <span data-testid="current-question">{currentQuestion + 1}</span>/10
                    </span>
                  </div>
